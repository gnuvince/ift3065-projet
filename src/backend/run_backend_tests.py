...
TESTS = [
    ...
    ("test_fact.scm"           , 24<<2),
    ("test_loop1.scm"          , 5<<2),
    ("test_mutation.scm"       , 4<<2),
    ("test_set_car.scm"        , 5<<2),
    ("test_set_cdr.scm"        , 5<<2),
    ("test_closure1.scm"       , 3<<2),
    ("test_closure2.scm"       , 7<<2),
    ("test_closure3.scm"       , 7<<2),
    ("test_closure4.scm"       , 15<<2),
    ("test_list1.scm"          , 1<<2),
    ("test_list2.scm"          , 10<<2),
    ...
    ("test_map.scm"            , 3<<2),
    ("test_char1.scm"          , 10<<2),
    ("test_string1.scm"        , 5<<2),
    ("test_string2.scm"        , 5<<2),
    ("test_string3.scm"        , 1<<2),
    ("test_sym1.scm"           , 1<<2),
    ("test_sym2.scm"           , 1<<2),
    ("test_sym3.scm"           , 1<<2),
    ("test_quoted_list.scm"    , 6<<2),
    ("test_display_string.scm" , 0<<2),
    ("test_display_int.scm"    , 0<<2),
